...
- commit: `6a6a2043d6789bbc85ebd9043f02955edf861a8e`
- branch: `wfx/r25/web`
- environment: web-fixtures @ http://localhost:3101
- window: 2026-09-22T01:29:54.282Z → 2026-09-22T01:36:10.237Z

**38 passed · 3 failed · 0 not-run (listed with procedures) · 41 total**
...
| J40 | YouTube viewer parity | **FAIL** | 26 | 3 |
...
- **J40 YouTube viewer parity**: journey assertion failed: the session queue's own seam carries the queued item (the queue pairing's honest state)
  expected: the /api/queue state lists Deep Field Diary
