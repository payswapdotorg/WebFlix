...
- window: 2026-09-20T17:12:23.648Z → 2026-09-20T17:12:37.935Z

**0 passed · 1 failed · 0 not-run (listed with procedures) · 1 total**

| Journey | Title | Status | Assertions | Artifacts |
|---|---|---|---:|---:|
| J36 | Major user journey completion / no dead-end discovery | **FAIL** | 0 | 2 |
...
- **J36 Major user journey completion / no dead-end discovery**: harness/browser failure: agent-browser command failed (1): open http://localhost:3101/
