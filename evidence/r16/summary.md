...
- commit: `30e5cebb9d45533d67d3865e28d27a14253a1a45`
- branch: `wfx/r25/integration`
- environment: web-fixtures @ http://localhost:3101
- window: 2026-09-22T06:50:20.621Z → 2026-09-22T06:51:17.973Z

**0 passed · 2 failed · 0 not-run (listed with procedures) · 2 total**

| Journey | Title | Status | Assertions | Artifacts |
|---|---|---|---:|---:|
| J40 | YouTube viewer parity | **FAIL** | 32 | 0 |
| J41 | YouTube-equivalent playback startup | **FAIL** | 0 | 3 |
...
- **J40 YouTube viewer parity**: harness/browser failure: agent-browser command failed (1): open http://localhost:3101/item?id=wfxitm_1JK68V58K12DV0JP15YD2WG0J9&connector=fake-source&ref=fake%3Avideo-1&title=Deep+Field+Diary&type=video&duration=1800000
✗ Navigation failed: net::ERR_CONNECTION_REFUSED
- **J41 YouTube-equivalent playback startup**: harness/browser failure: agent-browser command failed (1): open http://localhost:3101/search?q=Deep%20Field
✗ Navigation failed: net::ERR_CONNECTION_REFUSED
